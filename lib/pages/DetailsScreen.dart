...
final heroTag;
//Declaramos una varible para llamar delsde el home screen que sea 
final Wpoknom;
final WpokTipo;
final WpokNum;
final WpokImg;
    ...
    return Scaffold(
      backgroundColor: 
       widget.WpokTipo=="Grass" ? Colors.greenAccent 
          ...
          : widget.WpokTipo=="Fighting" ? Colors.orangeAccent
  ...
  Widget _FlechaAtras(){
    return Positioned(
        ...
        child: IconButton(
          ...
          onPressed: (){
            Navigator.pop(context);//Esto es la que nos Permite volver atras con la flecha
          },
        )
      );
  }
  ...
  Widget _NombreNumeroPokemon(){
    return Positioned(
      ...
      child: Row(
        ...
        children: [
          Text(//aca cambiamos el nombre para hacerlo dinamico
